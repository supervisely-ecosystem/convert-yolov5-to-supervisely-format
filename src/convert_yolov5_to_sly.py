...
@my_app.callback("yolo_sly_converter")
@sly.timeit
def yolo_sly_converter(api: sly.Api, task_id, context, state, app_logger):
...
def main():
    ...
    my_app.run(initial_events=[{"command": "yolo_sly_converter"}])
